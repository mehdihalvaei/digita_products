...
class Gateway(models.Model):
    ...
    # credenrials = models.TextField(_('credentials'),blank=True)
...
class Payment(models.Model):
    ...
    status = models.PositiveSmallIntegerField(_('status'),choices=STATUS_VOID,db_index=True)
    ...
    consumed_code = models.PositiveIntegerField(_('consumed reference code'), null=True)
